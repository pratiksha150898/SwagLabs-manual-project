...
Performed manual testing of Swag Labs demo application.

Verified functionalities including login, product selection, adding/removing items from cart, and checkout process.

Ensured smooth user experience by validating workflows and application behavior.
